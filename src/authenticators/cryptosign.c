...
char *sign_crypto_sign_challenge(const char *private_key_hex, const char *challenge_hex)
{
    ...
    if (sodium_hex2bin(seed, sizeof(seed), private_key_hex, strlen(private_key_hex), NULL, NULL,
                       NULL) != 0)
        return NULL;
    ...
    if (sodium_hex2bin(challenge, challenge_len, challenge_hex, challenge_hex_len, NULL, NULL,
                       NULL) != 0)
    {
        free(challenge);
        return NULL;
